...
[releases page]: https://github.com/langston-barrett/linkup/releases
...
curl \
  ...
  --silent \
  --tlsv1.2 \
  https://github.com/langston-barrett/linkup/releases/download/vX.Y.Z/linkup-TARGET.gz | \
  gunzip --to-stdout > linkup
```
...
```sh
cargo install --locked --git https://github.com/langston-barrett/linkup.git linkup
```
